#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""把当日疫情日报要点推送到办公渠道: 企业微信群机器人 / 钉钉机器人 / 邮箱。
